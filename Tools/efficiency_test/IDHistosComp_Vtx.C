...
void IDHistosCompF(TString plot        = "Vtx",     
		   TString region      = "Full",   
		   TString ID          = "TRK",   
		   TString muon        = "FAKE",   
  ...
  if(Rebinning){
    ...
    int NewBins=17;
    Double_t xbins[18] = {0,10,15,20,22,24,26,28,30,32,34,36,38,40,42,44,50,60};
...
void IDHistosCompR(TString hnID = "", TString hnMu = ""){
  ...
  IDHistosCompF("Vtx","Full", hnID, hnMu, LongName + hnID + " muons","N. Vertices","N.Muons",-1,-1,false,false,false);
  IDHistosCompF("Vtx","Full", hnID, hnMu, LongName + hnID + " muons","N. Vertices","N.Muons",-1,-1,false,false,true);
  IDHistosCompF("Vtx","Full", hnID, hnMu, LongName + hnID + " muons","N. Vertices","N.Muons",-1,-1,false,true, true);
  IDHistosCompF("Vtx","Full", hnID, hnMu, LongName + hnID + " muons","N. Vertices","N.Muons",-1,-1,false,true, false);
  IDHistosCompF("Vtx","Full", hnID, hnMu, LongName + hnID + " muons","N. Vertices","N.Muons",-1,-1,true,false,false);
  IDHistosCompF("Vtx","Full", hnID, hnMu, LongName + hnID + " muons","N. Vertices","N.Muons",-1,-1,true,false,true);
  IDHistosCompF("Vtx","Full", hnID, hnMu, LongName + hnID + " muons","N. Vertices","N.Muons",-1,-1,true,true, true);
  IDHistosCompF("Vtx","Full", hnID, hnMu, LongName + hnID + " muons","N. Vertices","N.Muons",-1,-1,true,true, false);

  IDHistosCompF("Vtx","Barrel", hnID, hnMu, LongName + hnID + " muons (Barrel |#eta|<1.2)","N. Vertices","N.Muons",-1,-1,false,false,false);
  IDHistosCompF("Vtx","Barrel", hnID, hnMu, LongName + hnID + " muons (Barrel |#eta|<1.2)","N. Vertices","N.Muons",-1,-1,false,false,true);
  IDHistosCompF("Vtx","Barrel", hnID, hnMu, LongName + hnID + " muons (Barrel |#eta|<1.2)","N. Vertices","N.Muons",-1,-1,false,true, true);
  IDHistosCompF("Vtx","Barrel", hnID, hnMu, LongName + hnID + " muons (Barrel |#eta|<1.2)","N. Vertices","N.Muons",-1,-1,false,true, false);
  IDHistosCompF("Vtx","Barrel", hnID, hnMu, LongName + hnID + " muons (Barrel |#eta|<1.2)","N. Vertices","N.Muons",-1,-1,true,false,false);
  IDHistosCompF("Vtx","Barrel", hnID, hnMu, LongName + hnID + " muons (Barrel |#eta|<1.2)","N. Vertices","N.Muons",-1,-1,true,false,true);
  IDHistosCompF("Vtx","Barrel", hnID, hnMu, LongName + hnID + " muons (Barrel |#eta|<1.2)","N. Vertices","N.Muons",-1,-1,true,true, true);
  IDHistosCompF("Vtx","Barrel", hnID, hnMu, LongName + hnID + " muons (Barrel |#eta|<1.2)","N. Vertices","N.Muons",-1,-1,true,true, false);

  IDHistosCompF("Vtx","Endcap", hnID, hnMu, LongName + hnID + " muons (Endcap |#eta|>1.2)","N. Vertices","N.Muons",-1,-1,false,false,false);
  IDHistosCompF("Vtx","Endcap", hnID, hnMu, LongName + hnID + " muons (Endcap |#eta|>1.2)","N. Vertices","N.Muons",-1,-1,false,false,true);
  IDHistosCompF("Vtx","Endcap", hnID, hnMu, LongName + hnID + " muons (Endcap |#eta|>1.2)","N. Vertices","N.Muons",-1,-1,false,true, true);
  IDHistosCompF("Vtx","Endcap", hnID, hnMu, LongName + hnID + " muons (Endcap |#eta|>1.2)","N. Vertices","N.Muons",-1,-1,false,true, false);
  IDHistosCompF("Vtx","Endcap", hnID, hnMu, LongName + hnID + " muons (Endcap |#eta|>1.2)","N. Vertices","N.Muons",-1,-1,true,false,false);
  IDHistosCompF("Vtx","Endcap", hnID, hnMu, LongName + hnID + " muons (Endcap |#eta|>1.2)","N. Vertices","N.Muons",-1,-1,true,false,true);
  IDHistosCompF("Vtx","Endcap", hnID, hnMu, LongName + hnID + " muons (Endcap |#eta|>1.2)","N. Vertices","N.Muons",-1,-1,true,true, true);
  IDHistosCompF("Vtx","Endcap", hnID, hnMu, LongName + hnID + " muons (Endcap |#eta|>1.2)","N. Vertices","N.Muons",-1,-1,true,true, false);

  IDHistosCompF("Vtx","Overlap", hnID, hnMu, LongName + hnID + " muons (Overlap 0.9<|#eta|<1.3)","N. Vertices","N.Muons",-1,-1,false,false,false);
  IDHistosCompF("Vtx","Overlap", hnID, hnMu, LongName + hnID + " muons (Overlap 0.9<|#eta|<1.3)","N. Vertices","N.Muons",-1,-1,false,false,true);
  IDHistosCompF("Vtx","Overlap", hnID, hnMu, LongName + hnID + " muons (Overlap 0.9<|#eta|<1.3)","N. Vertices","N.Muons",-1,-1,false,true, true);
  IDHistosCompF("Vtx","Overlap", hnID, hnMu, LongName + hnID + " muons (Overlap 0.9<|#eta|<1.3)","N. Vertices","N.Muons",-1,-1,false,true, false);
  IDHistosCompF("Vtx","Overlap", hnID, hnMu, LongName + hnID + " muons (Overlap 0.9<|#eta|<1.3)","N. Vertices","N.Muons",-1,-1,true,false,false);
  IDHistosCompF("Vtx","Overlap", hnID, hnMu, LongName + hnID + " muons (Overlap 0.9<|#eta|<1.3)","N. Vertices","N.Muons",-1,-1,true,false,true);
  IDHistosCompF("Vtx","Overlap", hnID, hnMu, LongName + hnID + " muons (Overlap 0.9<|#eta|<1.3)","N. Vertices","N.Muons",-1,-1,true,true, true);
  IDHistosCompF("Vtx","Overlap", hnID, hnMu, LongName + hnID + " muons (Overlap 0.9<|#eta|<1.3)","N. Vertices","N.Muons",-1,-1,true,true, false);


}

void IDHistosComp_Vtx(){
