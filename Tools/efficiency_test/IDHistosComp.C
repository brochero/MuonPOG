...
void IDHistosCompF(TString plot        = "Pt",     
  ...
  TString fname   = "histos_FullHIPStudiesOverlapingNewBinKinVar";
  ...
  Ratio_01 = (TH1F*)h_4->Clone();
  Ratio_01->SetLineColor(hcol[4]);
  Ratio_02 = (TH1F*)h_5->Clone();
  Ratio_02->SetLineColor(hcol[5]);
...
void IDHistosCompR(TString hnID = "", TString hnMu = ""){
  ...
  IDHistosCompF("Pt","Barrel", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,false,false,false);
  IDHistosCompF("Pt","Barrel", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,false,false,true);
  IDHistosCompF("Pt","Barrel", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,false,true, true);
  IDHistosCompF("Pt","Barrel", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,false,true, false);
  IDHistosCompF("Pt","Barrel", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,true,false,false);
  IDHistosCompF("Pt","Barrel", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,true,false,true);
  IDHistosCompF("Pt","Barrel", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,true,true, true);
  IDHistosCompF("Pt","Barrel", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,true,true, false);

  IDHistosCompF("Pt","Endcap", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,false,false,false);
  IDHistosCompF("Pt","Endcap", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,false,false,true);
  IDHistosCompF("Pt","Endcap", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,false,true, true);
  IDHistosCompF("Pt","Endcap", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,false,true, false);
  IDHistosCompF("Pt","Endcap", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,true,false,false);
  IDHistosCompF("Pt","Endcap", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,true,false,true);
  IDHistosCompF("Pt","Endcap", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,true,true, true);
  IDHistosCompF("Pt","Endcap", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,true,true, false);

  IDHistosCompF("Pt","Overlap", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,false,false,false);
  IDHistosCompF("Pt","Overlap", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,false,false,true);
  IDHistosCompF("Pt","Overlap", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,false,true, true);
  IDHistosCompF("Pt","Overlap", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,false,true, false);
  IDHistosCompF("Pt","Overlap", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,true,false,false);
  IDHistosCompF("Pt","Overlap", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,true,false,true);
  IDHistosCompF("Pt","Overlap", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,true,true, true);
  IDHistosCompF("Pt","Overlap", hnID, hnMu, LongName + hnID + " muons","pT[GeV]","N.Muons",-1,-1,true,true, false);
